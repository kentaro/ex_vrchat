defmodule VRChatOSC.OSC.Types.Float do
  @moduledoc """
  ...
  results if you encode and then immediately decode a float:
      ...
      iex> 0.333 |> VRChatOSC.OSC.Types.Float.encode() |> VRChatOSC.OSC.Types.Float.decode()
      {0.3330000042915344, ""}
  ...
  Returns `?f`, the type tag for the OSC float type
      ...
      iex> <<VRChatOSC.OSC.Types.Float.type_tag()>>
      "f"
  """
  def type_tag, do: ?f
  ...
  ## Examples
      ...
      iex> VRChatOSC.OSC.Types.Float.encode(0.3333)
      <<62, 170, 166, 76>>
  """
  ...
  ## Examples
      ...
      iex> <<63, 128, 0, 0>> |> VRChatOSC.OSC.Types.Float.decode()
      {1.0, ""}
  
      iex> <<68, 249, 184, 0, 234>> |> VRChatOSC.OSC.Types.Float.decode()
      {1997.75, <<234>>}
  """
